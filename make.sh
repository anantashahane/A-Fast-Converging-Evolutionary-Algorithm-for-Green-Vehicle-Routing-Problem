...
if [ $# -eq 0 ]; then 
    ...
    echo "  SelfAdpatationLSD: is a model that searches for optimal strictness using LSD like random number generator."
...
case $1 in
    ...
    SelfAdpatationLSD) swiftc -o run Miscellaneous.swift SelfAdaptationLSD/*.swift SelfAdaptationLSD/Genetic\ Algorithm/*.swift ;;
